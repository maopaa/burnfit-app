...
class CheckableGender : CardView, Checkable {
    ...
    private fun init(attrs: AttributeSet?) {
        LayoutInflater.from(context).inflate(R.layout.checkable_gender, this, true)
        ...
        if (attrs != null) {
            val ta = context.obtainStyledAttributes(attrs, R.styleable.CheckableGender, 0, 0)
            try {
